...
class SettingsPrivacyViewController: UIViewController {
    ...
    func loadTextIntoView() {
        ...
        let privacyBody = "This app (The 92) stores a record of football grounds a user has visited. No personal identifying information is stored, harvested, or transmitted back to us (ejesoftware.com). This app stores photos that the user chooses to add to a stadium visit record, that may be stored elsewhere on the device. We (ejesoftware.com) do not have access to the visit records or photos stored in this app. The user may remove all stored data in this app by accessing the settings page and touching on Reset Stadium Count, or Remove Photos.\n\n"
